...
public class InstitutionDetailsFragment extends Fragment {
     ...
     * number.
     */
    public static InstitutionDetailsFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_institution_details, container, false);
        return rootView;
    }
